...
router.get('/letter', function (req, res) {
    //wkhtmltopdf(fs.createReadStream('app/views/letter.html'), { output: 'out.pdf'} )
    wkhtmltopdf(fs.createReadStream('app/views/letter.html'), {
      pageSize: 'A4',
      ...
      marginRight: '20mm',
      marginTop: '20mm',
      footerLeft: 'Read the other side of this letter',
      footerSpacing: '10',
      footerLine: true,
      footerFontSize: 12
    } ).pipe(res)
...
router.get('/letter-html', function (req, res) {
  res.render('letter')
})
